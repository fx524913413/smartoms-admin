package com.zorkdata.center.auth.runner;

import com.zorkdata.center.auth.common.util.jwt.RsaKeyHelper;
 ...
 * @description: ${todo}
 * @author: zhuzhigang
 * @create: 2018/3/21 8:38
 */
@Configuration
public class AuthServerRunner implements CommandLineRunner {
    @Autowired
    private RedisTemplate<String, String> redisTemplate;
    private static final String REDIS_USER_PRI_KEY = "CENTER:AUTH:JWT:PRI";
    private static final String REDIS_USER_PUB_KEY = "CENTER:AUTH:JWT:PUB";
    private static final String REDIS_SERVICE_PRI_KEY = "CENTER:AUTH:CLIENT:PRI";
    private static final String REDIS_SERVICE_PUB_KEY = "CENTER:AUTH:CLIENT:PUB";
