...
import com.zorkdata.center.auth.bean.ClientInfo;
import com.zorkdata.center.auth.entity.Client;
import com.zorkdata.center.auth.mapper.ClientMapper;
import com.zorkdata.center.auth.service.AuthClientService;
import com.zorkdata.center.auth.util.client.ClientTokenUtil;
import com.zorkdata.center.common.util.UUIDUtils;
...
public class DBAuthClientService implements AuthClientService {
    ...
    private Client getClient(String clientId, String secret) throws Exception {
        ...
        if (client == null || !client.getSecret().equals(secret)) {
            throw new Exception("Client not found or Client secret is error!");
        }
        return client;
    }
