...
import com.zorkdata.center.common.salt.netapi.results.CmdExecCodeAll;
...
public class Cmd {
    ...
    public static LocalCall<String> execCode(String lang, String code, LinkedHashMap<String, Object> args) {
        return new LocalCall<>("cmd.exec_code", Optional.of(Arrays.asList(lang, code)),
                Optional.of(args), new TypeToken<String>() {
        });
    }
